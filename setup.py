...
setup(
    ...
    description='Advisory Infrastructure Setup Toolset - The Python Package',  # Optional
    ...
    url='https://github.com/derstolz/aws-kommandos',  # Optional
    ...
    # larger catalog.
    keywords='pentest, red-team, aws',  # Optional
    ...
    # for the setup script to run. setuptools will attempt to obtain these
    ...
    entry_points={  # Optional
        'console_scripts': [
            'aws-kommandos=aws_kommandos.kommandos:main',
        ],
    },
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/derstolz/aws-kommandos/issues',
        'Source': 'https://github.com/derstolz/aws-kommandos',
    },
)
